...
SRCS	:= cub3d.c read_map.c check_error.c save_textures.c utils/get_next_line.c utils/get_next_line_utils.c utils/utils1.c utils/utils2.c utils/ft_split.c 
OBJS	:= ${SRCS:.c=.o}
CC	:= clang
all: $(NAME)
libmlx:
